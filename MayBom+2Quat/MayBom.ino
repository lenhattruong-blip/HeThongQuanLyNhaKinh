...
const int pumpPin = 18;  // Chân điều khiển Bơm (Relay 1)
const int fan1Pin = 21;  // Chân điều khiển Quạt 1 (Relay 2)
const int fan2Pin = 47;  // Chân điều khiển Quạt 2 (Relay 3)
